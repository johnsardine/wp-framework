...
function of_sanitize_text($input) {
	global $allowedtags;
	$allowedtags = array('a' => array('href' => array(),'title' => array()),'br' => array(),'em' => array(),'strong' => array());
...
function of_sanitize_rawtextarea($input) {
	return $input;
}

add_filter( 'of_sanitize_rawtextarea', 'of_sanitize_rawtextarea' );

function of_sanitize_textareasmall($input) {
	global $allowedtags;
	$allowedtags = array('a' => array('href' => array(),'title' => array()),'br' => array(),'em' => array(),'strong' => array());
	$output = wp_kses( $input, $allowedtags);
	return $output;
...
add_filter( 'of_sanitize_textareasmall', 'of_sanitize_textareasmall' );
